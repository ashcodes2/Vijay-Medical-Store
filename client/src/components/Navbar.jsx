          ...
          >
            <div className="flex flex-col p-6 gap-2">
              ...
              <a
                href="#admin"
                onClick={closeMobileMenu}
                className="text-sm font-semibold text-on-surface-variant hover:text-primary py-2.5 px-4 rounded-xl hover:bg-surface-container transition-colors flex items-center gap-2"
              >
                <span className="w-2 h-2 rounded-full bg-[#d1a154]" />
                Admin Portal Login
              </a>
            </div>
          </motion.div>
