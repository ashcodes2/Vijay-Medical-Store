        ...
        <div className="relative">
          ...
          >
            ...
            <motion.div
              ...
              className="absolute -bottom-6 left-2 sm:-bottom-8 sm:-left-8 bg-surface p-4 sm:p-6 rounded-2xl shadow-xl z-20 max-w-[220px] sm:max-w-[260px] border border-outline-variant/10"
            >
